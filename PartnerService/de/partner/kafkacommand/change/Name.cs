...
namespace de.partner.kafkacommand.change
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"Name\",\"namespace\":\"de.partner.kafkacommand.change\",\"fiel" +
				"ds\":[{\"name\":\"firstname\",\"type\":\"string\"},{\"name\":\"lastname\",\"type\":\"string\"}]}");
