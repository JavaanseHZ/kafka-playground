...
public class VertragCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public de.vertrag.created.Name Name;
   ...
   */
  public VertragCreated(java.lang.String id, de.vertrag.created.Name Name, java.lang.String sparte, java.lang.Double beitrag) {
    this.id = id;
    this.Name = Name;
    this.sparte = sparte;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: Name = (de.vertrag.created.Name)value$; break;
   ...
   */
  public de.vertrag.created.Name getName() {
    return Name;
  }
   ...
   * @param value the value to set.
   */
  public void setName(de.vertrag.created.Name value) {
    this.Name = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VertragCreated>
    ...
    private de.vertrag.created.Name Name;
    private de.vertrag.created.Name.Builder NameBuilder;
    ...
    private Builder(de.vertrag.created.VertragCreated.Builder other) {
      ...
      if (other.hasNameBuilder()) {
        this.NameBuilder = de.vertrag.created.Name.newBuilder(other.getNameBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public de.vertrag.created.VertragCreated.Builder setName(de.vertrag.created.Name value) {
     ...
     * @return This builder.
     */
    public de.vertrag.created.Name.Builder getNameBuilder() {
      if (NameBuilder == null) {
        if (hasName()) {
          setNameBuilder(de.vertrag.created.Name.newBuilder(Name));
        } else {
          setNameBuilder(de.vertrag.created.Name.newBuilder());
        }
      }
      return NameBuilder;
    }
     ...
     * @return This builder.
     */
    public de.vertrag.created.VertragCreated.Builder setNameBuilder(de.vertrag.created.Name.Builder value) {
      clearName();
      NameBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public de.vertrag.created.VertragCreated.Builder clearName() {
      Name = null;
      NameBuilder = null;
    ...
    public VertragCreated build() {
      try {
        ...
        if (NameBuilder != null) {
          ...
          record.Name = fieldSetFlags()[1] ? this.Name : (de.vertrag.created.Name) defaultValue(fields()[1]);
        }
