...
namespace de.client.kafkaevent.changed
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"Address\",\"namespace\":\"de.client.kafkaevent.changed\",\"fie" +
				"lds\":[{\"name\":\"street\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"}]}");
