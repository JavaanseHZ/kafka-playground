...
namespace de.partner.kafkaevent.changed
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"Name\",\"namespace\":\"de.partner.kafkaevent.changed\",\"field" +
				"s\":[{\"name\":\"firstname\",\"type\":\"string\"},{\"name\":\"lastname\",\"type\":\"string\"}]}");
