...
arrow (canvasDemoAppConnect, canvasDemoAppConnect.width - 100, ycanvasDemoAppConnectCenter - 100, xcanvasDemoAppConnectCenter + 145, ycanvasDemoAppConnectCenter - 15, transientWhite);
arrow (canvasDemoAppConnect, xcanvasDemoAppConnectCenter + 145, ycanvasDemoAppConnectCenter - 60, canvasDemoAppConnect.width - 210, ycanvasDemoAppConnectCenter -100, transientWhite);
...
rectangleArray(canvasDemoAppConnect, 25, canvasDemoAppConnect.height - 50, 250, 40, purple, [['id', 'black'], ['ts', 'black'], ['oldId', 'black'], ['newId', 'black']]);
ellipse(canvasDemoAppConnect, 50, canvasDemoAppConnect.height - 130, 200, 80, purple, 'Postgres', 'black');
...
rectangle(canvasDemoAppConnect, canvasDemoAppConnect.width - 275, canvasDemoAppConnect.height - 50, 250, 40, purple, 'Contracts (Json)', 'black');
ellipse(canvasDemoAppConnect, canvasDemoAppConnect.width - 250, canvasDemoAppConnect.height - 130, 200, 80, purple, 'Elastic', 'black');
