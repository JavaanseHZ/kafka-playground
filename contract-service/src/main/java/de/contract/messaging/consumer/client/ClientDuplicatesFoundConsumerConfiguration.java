...
public class ClientDuplicatesFoundConsumerConfiguration extends ConsumerConfiguration {
    ...
    private ConsumerFactory<String, ClientdublettenFound> clientdublettenFoundConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ClientdublettenFound>
    clientdublettenFoundKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ClientdublettenFound> factory
                = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(clientdublettenFoundConsumerFactory());
        return factory;
    }
}
